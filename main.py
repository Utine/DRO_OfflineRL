...
if __name__ == "__main__":
    ...
    #     args.buffersize = base_buffersize + i*200
    ...
    # wandb.log({"DRO_RewardDiff_Dataset_Size": wandb.Image('imgs/DRO/' + 'RewardDiff_Dataset_Size.png')})
    # plt.show()
    # plt.close()
    #
    # sns.lmplot(data=pd, x='Dataset Size', y='Step Cost')
    # plt.savefig('imgs/DRO/' + 'StepCost_Dataset_Size.png', dpi=200)
    # wandb.log({"DRO_StepCost_Dataset_Size": wandb.Image('imgs/DRO/' + 'StepCost_Dataset_Size.png')})
    # plt.show()
    # plt.close()
    #
    ...
    # wandb.log({"DRO_RewardDiff_Gamma": wandb.Image('imgs/DRO/' + 'RewardDiff_Gamma.png')})
    # plt.show()
    # plt.close()
    #
    # sns.lmplot(data=pd, x='Gamma Range', y='Step Cost')
    # plt.savefig('imgs/DRO/' + 'StepCost_Gamma.png', dpi=200)
    # wandb.log({"DRO_StepCost_Gamma": wandb.Image('imgs/DRO/' + 'StepCost_Gamma.png')})
    # plt.show()
    # plt.close()
    ...
    wandb.log({"DP_EXP_RewardDiff_Dataset_Size": wandb.Image('imgs/DP_EXP/' + 'RewardDiff_Dataset_Size.png')})
    plt.show()
    plt.close()

    sns.lmplot(data=pd, x='Dataset Size', y='Step Cost')
    plt.savefig('imgs/DP_EXP/' + 'StepCost_Dataset_Size.png', dpi=200)
    wandb.log({"DP_EXP_StepCost_Dataset_Size": wandb.Image('imgs/DP_EXP/' + 'StepCost_Dataset_Size.png')})
    plt.show()
    plt.close()
    ...
    wandb.log({"DP_EXP_RewardDiff_Gamma": wandb.Image('imgs/DP_EXP/' + 'RewardDiff_Gamma.png')})
    plt.show()
    plt.close()

    sns.lmplot(data=pd, x='Gamma Range', y='Step Cost')
    plt.savefig('imgs/DP_EXP/' + 'StepCost_Gamma.png', dpi=200)
    wandb.log({"DP_EXP_StepCost_Gamma": wandb.Image('imgs/DP_EXP/' + 'StepCost_Gamma.png')})
    plt.show()
    plt.close()
